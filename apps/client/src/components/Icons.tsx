 ...
 * SR-DEV: Centralized Icon Repository
 * ACTION: Added FileText and Building icons for new features/fixes.
 */

// NOTE: These are custom implementations of Lucide icons to ensure consistent SVG export.
...
export const Loader2Icon = (props: SVGProps<SVGSVGElement>) => (
  ...
  export const MindNamoLogo = (props: SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
